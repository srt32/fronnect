...
user = User.create(email: "jonah@example.com", password: "password")
user = User.create(email: "kevin@example.com", password: "password")
user = User.create(email: "lauren@example.com", password: "password")
user = User.create(email: "bryana@example.com", password: "password")
