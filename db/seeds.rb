...
event3 = user3.events.create(title: "Skiing", description: "Day trip to Vail", venue: "Vail Resort", address: "Vail, CO", start_date: "2014-01-25", start_hour: 18, end_hour: 20 )
...
event6 = user6.events.create(title: "6-Pack and Hack", description: "Much needed", venue: "Lauren's House", address: "Boulder, CO", start_date: "2014-01-02", start_hour: 8, end_hour: 18 )
