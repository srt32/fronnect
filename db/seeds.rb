...
event6 = user6.events.create(title: "6-Pack and Hack", description: "Much needed", venue: "Lauren's House", address: "Boulder, CO", day_of_week: "5", start_hour: 8, end_hour: 18 )
